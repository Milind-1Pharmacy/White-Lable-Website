...
export const PUBLISH_OVERLAY: React.CSSProperties = { position: "fixed", inset: 0, background: "rgba(20,32,56,.42)", backdropFilter: "blur(6px)", zIndex: 70, display: "flex", alignItems: "center", justifyContent: "center", padding: 24, overflow: "hidden" };
