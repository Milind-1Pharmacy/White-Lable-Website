        ...
        <div className="split__head">
          <div>
            ...
            <h2 className="h-display h-2" style={{ marginTop: 14 }}>
              Our <span className="serif-it" style={{ color: "var(--accent)" }}>AI-driven</span> retail stores.
            </h2>
          </div>
          ...
          <div className="split__tile" style={{ background: "var(--ink)" }}>
            {!playing ? (
              <>
                ...
                <span className="imgbox__tag" style={{ background: "rgba(0,178,122,.95)", color: "var(--ink)" }}>
